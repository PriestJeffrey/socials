...
const SECRET_PATTERNS: RegExp[] = [
  ...
  /\b(TOKEN_ENCRYPTION_KEY|SESSION_SECRET|META_APP_SECRET|LINKEDIN_CLIENT_SECRET|THREADS_APP_SECRET|TIKTOK_CLIENT_SECRET|TIKTOK_CLIENT_KEY|GEMINI_API_KEY|CRON_SECRET)\s*[:=]?\s*\S+/gi,
];
